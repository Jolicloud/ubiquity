...
class Wizard(BaseFrontend):
    ...
    def get_hostname (self):
        """ XXX: Hardcoding the hostname here. If this isn't done, it may be
        pulled from ubiquity's debconf DB as 'netcfg/get_hostname' or
        autogenerated. We want to force the hostname to be this, for now. """
        self.hostname.set_text('jolicloud')
